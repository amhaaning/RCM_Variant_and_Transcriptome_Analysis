...
vcf_out=RCM_WES_Apr18_Joint_INDELs_SelectVariants_Final_Anno_Filt_Max_AF.vcf
...
vcftools --vcf RCM_WES_Apr18_Joint_INDELs_FINAL_Anno.vcf --extract-FORMAT-info GT
mv out.GT.FORMAT RCM_WES_Apr18_Joint_INDELs_FINAL_Anno_Variants.txt
